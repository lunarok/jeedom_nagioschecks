    ...
    <div class="col-lg-10 col-md-9 col-sm-8 eqLogic" style="border-left: solid 1px #EEE; padding-left: 25px;display: none;">
        <div class="row">
            ...
            <fieldset>
                ...
                <form class="form-horizontal">
                    <fieldset>
                        <legend>{{Configuration pour le mode SSH}}</legend>
        ...
        <div class="form-group">
          <label class="col-md-3 control-label">{{Emplacement de la clef}}</label>
          <div class="col-md-3">
            <input class="eqLogicAttr form-control" data-l1key="configuration" data-l2key="sshkey" placeholder="{{saisir le chemin}}">
          </div>
        </div>
        <div class="form-group">
          <label class="col-md-3 control-label">{{Chemin des check Nagios}}</label>
          <div class="col-md-3">
